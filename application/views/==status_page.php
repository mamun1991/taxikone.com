...
<div class="container pt-5">
    <div class="filterBox">
        ...
        <?php if ($this->session->userdata('admin')==1){ ?>
            <div class="oth">
                <div class="">
                    <label><input type="checkbox" <?= isset($_GET['ohrim']) ? 'checked' : '' ?>  name="ohrim" class="form-control"  value="1"> <p class="textLabel">All hotel ride I made!</p></label>
                </div>
            </div>
        <?php } ?>
