...
class Main extends CI_Controller
{
	...
	public function scdule()
	{
		...
		if ($this->session->userdata('admin') == '0') {
			$data['appoint_data_arival'] = $this->Main_model->fetch_appoint_details('Arrivals');
			$data['appoint_data_departure'] = $this->Main_model->fetch_appoint_details('Departures');
			$data['appoint_data'] = $this->Main_model->fetch_appoint_details();
		} else {
			$id = $this->session->userdata('id');
			$data['appoint_data_arival'] = $this->Main_model->fetch_appoint_details_by_user($id, 'Arrivals');
			$data['appoint_data_departure'] = $this->Main_model->fetch_appoint_details_by_user($id, 'Departures');
			$data['appoint_data'] = $this->Main_model->fetch_appoint_details($id);
		}
	...
	public function delete_driver(){
		...
		$data['driver'] = $this->Main_model->deleteRow('driver', $where);

		return redirect('Main/drive_view');
	}
